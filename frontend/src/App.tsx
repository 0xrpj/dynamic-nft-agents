...
function App() {
  ...
  return (
    <BrowserRouter>
      <Routes>
        <Route path="/" element={<Layout isDarkMode={gameState.isDarkMode} onToggleDarkMode={toggleDarkMode} />}>
          <Route index element={<Welcome isDarkMode={gameState.isDarkMode} />} />
          <Route
            path="select-nft"
            element={<NFTSelection onSelect={handleNFTSelect} points={gameState.points} isDarkMode={gameState.isDarkMode} />}
          />
          <Route
